...
class TestOrganizerRescheduledEmail extends OrganizerRescheduledEmail {
...
describe("OrganizerRescheduledEmail", () => {
  it("uses a compact attendee summary in the subject for multi-invitee meetings", async () => {
    const email = new TestOrganizerRescheduledEmail({
      calEvent: buildCalEvent(["Alex", "Blair", "Casey"]),
    });
